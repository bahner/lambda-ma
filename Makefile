...
publish: $(SCHEME_ACTOR_CID_FILE) $(SCHEME_STDLIB_CID_FILE) $(SCHEME_ACTOR_LIB_CID_FILE) $(SCHEME_STATE_CID_FILE) $(SCHEME_NODE_CID_FILE) $(CID_FILES)
